 ...
 * @property integer $persentasi_beban
...
class RppxDetailKuliah extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['kuliah_id', 'pegawai_id', 'kelas_riil', 'kelas_tatap_muka', 'kelas_praktikum', 'persentasi_beban', 'deleted', 'sks_teori', 'sks_praktikum'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'persentasi_beban' => 'Persentasi Beban',
            'deleted' => 'Deleted',
