...
$this->params['breadcrumbs'][] = $this->title;
    ...
    if($id != null){
        ...
        $tujuan                 = $pemakaian_kendaraan->tujuan;
        $jumlah_penumpang       = $pemakaian_kendaraan->jumlah_penumpang_kendaraan;
        $keperluan              = $pemakaian_kendaraan->desc;
    }
?>
...
-->
    ...
    <?= $form->field($model, 'pemakaian_kendaraan_id')->textInput([
            'value' => $id,
    ]) ?>
