...
<div class="paket-form">
    ...
    <?php // $form->field($model, 'penerima')->textInput(['maxlength' => true]) ?>

    <?php $form->field($model, 'pengirim')->textInput(['maxlength' => true]) ?>

    <?php // $form->field($model, 'tanggal_kedatangan')->textInput() ?>
<!--
...
-->
    ...
    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? 'Create' : 'Ambil', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
