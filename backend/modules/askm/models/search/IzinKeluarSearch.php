...
class IzinKeluarSearch extends IzinKeluar
{
    ...
    public function searchByDosenWali($params)
    {
        ...
        // $registrasi = Registrasi::find()->select(['adak_registrasi.dim_id'])->where('adak_registrasi.deleted!=1')->andWhere(['ta' => Yii::$app->appConfig->get('tahun_ajaran', true), 'sem_ta' => Yii::$app->appConfig->get('semester_tahun_ajaran', true)])->joinWith([
        //     'dosenWali.user' => function($query){
        ...
        $query->andFilterWhere([
            ...
            'status_request_keasramaan' => $this->status_request_keasramaan,
            'status_request_dosen_wali' => $this->status_request_dosen_wali,
            'sysx_user.user_id' => \Yii::$app->user->identity->user_id,
            'deleted' => $this->deleted,
            'deleted_at' => $this->deleted_at,
            'created_at' => $this->created_at,
            'updated_at' => $this->updated_at,
