...
class Kuliah extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_kur', 'sks', 'sem', 'urut_dlm_sem', 'sifat', 'lab_hour', 'tutorial_hour', 'course_hour', 'course_hour_in_week', 'lab_hour_in_week', 'number_week', 'other_activity_hour', 'knowledge', 'skill', 'attitude', 'uts', 'uas', 'tugas', 'quiz', 'status', 'ref_kbk_id', 'course_group_id', 'tahun_kurikulum_id', 'ekstrakurikuler', 'deleted'], 'integer'],
            [['kode_mk'], 'required'],
    ...
    {
        return $this->hasMany(BaakSuratPengantarProyek::className(), ['kuliah_id' => 'kuliah_id']);
    }
