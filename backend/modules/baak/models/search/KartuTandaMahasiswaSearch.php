...
class KartuTandaMahasiswaSearch extends KartuTandaMahasiswa
{
    ...
    {
        return [
            [['kartu_tanda_mahasiswa_id', 'deleted'], 'integer'],
            [['alasan', 'status_pengajuan_id', 'pemohon_id', 'deleted_at', 'deleted_by', 'created_at', 'created_by', 'updated_at', 'updated_by', 'waktu_pengambilan', 'alasan_penolakan'], 'safe'],
        ];
    }
