            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                  ...
                  <ul class="sidebar-menu">
                    ...
                    ?>
                    <li><a href="http://localhost/cis-lite/backend/web/index.php/ubux/posisi-paket/index"><i class="fa fa-map-marker"></i> <span>Posisi Paket</span></a></li>
                    <li><a href="http://localhost/cis-lite/backend/web/index.php/ubux/data-tamu/index"><i class="fa fa-user"></i> <span>Data Tamu</span></a></li>
                    <li><a href="http://localhost/cis-lite/backend/web/index.php/ubux/data-paket/index-by-admin"><i class="fa fa-archive"></i> <span>Paket By Admin</span></a></li>
                    <li><a href="http://localhost/cis-lite/backend/web/index.php/ubux/data-paket/index-by-mahasiswa"><i class="fa fa-archive"></i> <span>Paket By Mahasiswa</span></a></li>
                    <li><a href="http://localhost/cis-lite/backend/web/index.php/ubux/data-paket/index-by-pegawai"><i class="fa fa-archive"></i> <span>Paket By Pegawai</span></a></li>
                   <!--
                   -->
