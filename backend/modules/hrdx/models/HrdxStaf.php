 ...
 */
class HrdxStaf extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(AskmIzinKeluar::className(), ['staf_id' => 'staf_id']);
    }
    ...
    {
        return $this->hasMany(AskmIzinPenggunaanRuangan::className(), ['staf_id' => 'staf_id']);
    }
    ...
    {
        return $this->hasMany(AskmIzinTambahanJamKolaboratif::className(), ['staf_id' => 'staf_id']);
    }
