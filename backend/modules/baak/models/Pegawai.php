...
class Pegawai extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(BaakKaosDel::className(), ['hrdx_pegawai_pegawai_id' => 'pegawai_id']);
    }
    ...
    {
        return $this->hasMany(BaakKtm::className(), ['pegawai_id' => 'pegawai_id']);
    }
    ...
    {
        return $this->hasMany(BaakSuratLomba::className(), ['hrdx_pegawai_pegawai_id' => 'pegawai_id']);
    }
    ...
    {
        return $this->hasMany(BaakSuratMagang::className(), ['hrdx_pegawai_pegawai_id' => 'pegawai_id']);
    }
    ...
    {
        return $this->hasMany(BaakSuratMahasiswaAktif::className(), ['hrdx_pegawai_pegawai_id' => 'pegawai_id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getBaakSuratPengantarPas()
    {
        return $this->hasMany(BaakSuratPengantarPa::className(), ['hrdx_pegawai_pegawai_id' => 'pegawai_id']);
    }
    ...
    {
        return $this->hasMany(BaakSuratPengantarTa::className(), ['hrdx_pegawai_pegawai_id' => 'pegawai_id']);
    }
