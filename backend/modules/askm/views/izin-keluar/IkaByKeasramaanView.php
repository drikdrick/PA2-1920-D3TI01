...
$this->params['breadcrumbs'][] = ['label' => 'Izin Keluar', 'url' => ['index']];
...
<div class="izin-keluar-view">
    ...
    <?php
        if ($model->status_request_dosen_wali == 2 && $model->status_request_keasramaan == 2) {
    ?>
    ...
    } else if($model->status_request_dosen_wali == 2 && $model->status_request_keasramaan == 1){ ?>
